...
public class IceChargeEntity extends AdAstraPlaceholderProjectile {

    public IceChargeEntity(World world) {
        super(world);
        setSize(0.35F, 0.35F);
    }

    public IceChargeEntity(World world, EntityLivingBase thrower) {
        super(world, thrower);
        setSize(0.35F, 0.35F);
    }

    public IceChargeEntity(World world, double x, double y, double z) {
        super(world, x, y, z);
        setSize(0.35F, 0.35F);
    }
