...
public class FuelRefineryMenu extends MachineMenu<FuelRefineryTileEntity> {

    private static final int MACHINE_SLOT_COUNT = 5;

    public FuelRefineryMenu(InventoryPlayer inventory, FuelRefineryTileEntity entity) {
        super(inventory, entity, AdAstraMachineContainer.layoutFor(ModGuiIds.FUEL_REFINERY, entity));
