...
public abstract class BaseContainerMenu<T extends IInventory> extends Container {
    ...
    protected BaseContainerMenu(InventoryPlayer inventory, T entity) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        } else if (!mergeIntoContainerSlots(stack)) {
            return ItemStack.EMPTY;
        }
    ...
    protected boolean mergeIntoContainerSlots(ItemStack stack) {
