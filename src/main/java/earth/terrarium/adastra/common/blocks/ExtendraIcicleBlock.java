...
/** A small 1.12.2 equivalent of the pointed-dripstone icicle used by Extendra. */
public final class ExtendraIcicleBlock extends Block {
    ...
    public static void grow(World world, ExtendraIcicleBlock block, BlockPos tipPos,
    ...
    private static boolean isPointedDripstoneWithDirection(IBlockState state, EnumFacing direction) {
        return state.getBlock() instanceof ExtendraIcicleBlock
