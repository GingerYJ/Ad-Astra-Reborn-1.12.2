...
/** 1.12.2 tree replacement for the configured tree growers used by Ad Extendra. */
public final class ExtendraSaplingBlock extends BlockSapling {

    private final boolean glacian;

    public ExtendraSaplingBlock(boolean glacian) {
        super();
    ...
    public void generateTree(World world, BlockPos pos, IBlockState state, Random random) {
        ...
        Block log = glacian ? ModBlocks.GLACIAN_LOG : ExtendraBlocks.get("centaurian_oak_log");
        Block leaves = glacian ? ModBlocks.GLACIAN_LEAVES : ExtendraBlocks.get("centaurian_oak_leaves");
