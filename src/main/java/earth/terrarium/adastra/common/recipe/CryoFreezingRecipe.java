...
/**
 * Recipe implementation for the Cryo Freezer machine.
 * Freezes a single input item into a fluid output.
 */
public class CryoFreezingRecipe {
    ...
    /**
     * Creates a cryo freezing recipe.
     *
     * @param id Recipe identifier
     * @param input Input ItemStack
     * @param outputFluid Output fluid type
     * @param outputAmount Amount of fluid produced in millibuckets
     ...
     */
    public CryoFreezingRecipe(String id, ItemStack input, Fluid outputFluid, int outputAmount, int processingTime, int energyPerTick) {
        this.id = id;
